...
const businessAreas: BusinessArea[] = [
  {
    ...
    title: 'Channel Entry',
    description:
      'Track product movement from manufacturers to distributors and strategic partners. Gain full visibility into initial channel distribution.',
  },
  {
    icon: <ArrowRightLeft className="h-5 w-5" />,
    title: 'Partner Transfer',
    description:
      'Monitor product flow between distributors and channel partners. Ensure accurate tracking across the entire partner network.',
  },
  {
    icon: <ShoppingCart className="h-5 w-5" />,
    title: 'Customer Purchase',
    description:
      'Track product sales from channel partners to end customers. Capture point-of-sale data for complete revenue visibility.',
  },
  {
    icon: <Cpu className="h-5 w-5" />,
    title: 'Product Activation',
    description:
      'Connect activation records with channel movement data. Enable complete lifecycle tracking for every product unit.',
  },
  {
    icon: <FileText className="h-5 w-5" />,
    title: 'Claims Management',
    description:
      'Manage and track channel-related claims and incentive programs. Streamline rebates, promotions, and partner compensation.',
  },
  {
    icon: <Database className="h-5 w-5" />,
    title: 'External Data Integration',
    description:
      'Upload and manage business data from external sources. Centralize third-party data for unified reporting and analysis.',
  },
];
...
const journeySteps = [
  {
    title: 'Manufacturer',
    description: 'Products enter the channel network from manufacturers and suppliers.',
    icon: <Package className="h-5 w-5" />,
  },
  {
    title: 'Distributor',
    description: 'Distributors receive and forward products to channel partners.',
    icon: <Network className="h-5 w-5" />,
  },
  {
    title: 'Channel Partner',
    description: 'Partners sell products to end customers and manage local inventory.',
    icon: <ArrowRightLeft className="h-5 w-5" />,
  },
  {
    title: 'End Customer',
    description: 'Customers purchase products through the partner network.',
    icon: <ShoppingCart className="h-5 w-5" />,
  },
  {
    title: 'Activation',
    description: 'Products are activated and linked back to their channel journey.',
    icon: <Cpu className="h-5 w-5" />,
  },
];
        ...
        <div className="mx-auto max-w-7xl px-4 pb-24 pt-16 sm:px-6 lg:px-8">
          <div className="relative mx-auto max-w-4xl text-center">
            ...
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground sm:text-xl">
              ...
              Centralize operations, reduce dependency on technical teams,
              and gain real-time intelligence across every tier of your channel.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Follow every product from manufacturer through distribution to end-customer activation.
            </p>
          </div>
      ...
      <section className="border-b border-border py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Channel360 is purpose-built to support every stage of the channel ecosystem.
            </p>
          </div>
      ...
      <section className="border-b border-border bg-muted/30 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 mx-auto max-w-3xl space-y-4">
            {[
              {
                title: 'Complete Lifecycle Visibility',
                desc: 'Track every product from manufacturer to end customer with full activation visibility.',
              },
              {
                title: 'Centralized Operations',
                desc: 'Manage users, content, announcements, and partner communications in one place.',
              },
              {
                title: 'Dynamic Content Control',
                desc: 'Update homepage, promotions, and announcements without code deployments.',
              },
              {
                title: 'Secure by Design',
                desc: 'Role-based access control ensures users see only what they need.',
              },
              {
                title: 'Scalable Foundation',
                desc: 'Built for enterprise growth with a modular architecture ready for analytics and reporting.',
              },
            ].map((benefit) => (
              <div
                key={benefit.title}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-2xl border border-border bg-card px-8 py-16 text-center sm:px-16">
            ...
            <div className="relative">
              <h2 className="text-3xl font-bold text-foreground sm:text-4xl">
                Ready to Unify Your Channel Operations?
              </h2>
              <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
                Access the platform to manage your channel ecosystem, track product lifecycles,
